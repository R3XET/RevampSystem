...
public class SetRankCommand extends BaseCommand {
    ...
    @Command(name = "setrank", permission = "revampsystem.command.setrank", inGameOnly = false) @SuppressWarnings("deprecation")
    public void onCommand(CommandArgs command) {
        Tasks.runAsync(plugin, () -> {
            ...
            if (args.length < 5) {
                sender.sendMessage(Language.SETRANK_USAGE.toString());
                return;
            }
            ...
            String reason = CCUtils.buildMessage(args, 4);
