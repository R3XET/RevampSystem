...
public class RevampCommand extends BaseCommand {
    ...
    @Command(name = "revampsystem", inGameOnly = false, aliases = {"rsystem", "revamps"})
    public void onCommand(CommandArgs command) {
        Tasks.runAsync(plugin, () ->{
            ...
            if (args.length == 0) {
                ...
                sender.sendMessage(Color.translate("&bRevamp System made by &3R3XET&b!"));
                //sender.sendMessage(Color.translate("&bMC-Market username&7: &3R3XET"));
            ...
            if (args[0].equalsIgnoreCase("debug")) {
                ...
                sender.sendMessage(Color.translate("&7&m-----------------------------------------"));
                sender.sendMessage(Color.translate("&3&lRevamp System debug"));
                sender.sendMessage(" ");
                ...
                sender.sendMessage(Color.translate("&bPlugin author&7: &3" + eu.revamp.spigot.utils.string.StringUtils.getStringFromList(plugin.getDescription().getAuthors())));
                sender.sendMessage(Color.translate("&7&m-----------------------------------------"));
                return;
            }
