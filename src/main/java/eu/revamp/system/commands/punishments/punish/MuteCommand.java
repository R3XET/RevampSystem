...
public class MuteCommand extends BaseCommand {
    ...
    @Command(name = "mute", permission = "punishments.command.mute", inGameOnly = false, aliases = "tempmute") @SuppressWarnings("deprecation")
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            if (args.length < 2) {
                sender.sendMessage(PunishmentsLanguage.MUTE_USAGE.toString());
                return;
            }
