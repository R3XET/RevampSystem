...
public class StaffRollBackCommand extends BaseCommand {
    ...
    @Command(name = "staffrollback", permission = "punishments.command.staffrollback") @SuppressWarnings("deprecation")
    public void onCommand(CommandArgs command) {
        Tasks.runAsync(plugin, () -> {
            ...
            if (args.length < 2) {
                player.sendMessage(Language.STAFF_ROLLBACK_USAGE.toString());
                return;
            }
