...
public class WarnCommand extends BaseCommand {
    ...
    @Command(name = "warn", permission = "punishments.command.warn", inGameOnly = false) @SuppressWarnings("deprecation")
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            if (args.length < 2) {
                sender.sendMessage(PunishmentsLanguage.WARN_USAGE.toString());
                return;
            }
