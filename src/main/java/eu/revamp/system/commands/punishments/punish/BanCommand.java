...
public class BanCommand extends BaseCommand {
    ...
    @Command(name = "ban", inGameOnly = false, permission = "punishments.command.ban", aliases = {"tempban"}) @SuppressWarnings("deprecation")
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            if (args.length < 2) {
                sender.sendMessage(PunishmentsLanguage.BAN_USAGE.toString());
                return;
            }
