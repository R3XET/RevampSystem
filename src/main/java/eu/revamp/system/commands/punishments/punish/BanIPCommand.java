...
public class BanIPCommand extends BaseCommand {
    ...
    @Command(name = "banip", inGameOnly = false, permission = "punishments.command.banip", aliases = {"tempbanip", "ipban", "iptempban"}) @SuppressWarnings("deprecation")
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            if (args.length < 2) {
                sender.sendMessage(PunishmentsLanguage.IPBAN_USAGE.toString());
                return;
            }
