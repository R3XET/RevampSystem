...
public class UnBanCommand extends BaseCommand {
    ...
    @Command(name = "unban", inGameOnly = false, permission = "punishments.command.unban") @SuppressWarnings("deprecation")
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            if (args.length < 2) {
                sender.sendMessage(PunishmentsLanguage.UNBAN_USAGE.toString());
                return;
            }
