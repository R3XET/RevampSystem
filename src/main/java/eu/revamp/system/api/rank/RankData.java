package eu.revamp.system.api.rank;
...
public class RankData {
    ...
    public void save() {
        ...
        document.put("permissions", eu.revamp.spigot.utils.string.StringUtils.getStringFromList(this.getPermissions()));
        document.put("bungeePermissions", eu.revamp.spigot.utils.string.StringUtils.getStringFromList(this.getBungeePermissions()));
        document.put("prefix", this.getPrefix().replace("§", "&"));
        document.put("suffix", this.getSuffix().replace("§", "&"));
        document.put("color", CCUtils.convertChatColor(this.getColor()));
        document.put("default", this.isDefaultRank());
        document.put("inheritance", eu.revamp.spigot.utils.string.StringUtils.getStringFromList(this.getInheritance()));
        ...
        document.put("chatColor", CCUtils.convertChatColor(this.getChatColor()));
