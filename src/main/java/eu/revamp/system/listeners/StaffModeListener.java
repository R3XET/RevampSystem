...
import eu.revamp.system.data.staffmode.StaffModeItem;
import eu.revamp.system.events.VanishUpdateEvent;
import eu.revamp.system.menus.staffmode.OnlineStaffMenu;
...
public class StaffModeListener implements Listener {
    ...
    public void handleRightClickItem(PlayerInteractEvent event) {
        ...
        switch (staffModeItem.getAction().getAction()) {
            ...
            case "random-teleport" : {
                List<Player> players = PlayerUtils.getOnlinePlayers().stream().filter(online -> !online.hasPermission(plugin.getStaffModeManagement().getStaffPermission())).collect(Collectors.toList());
    ...
    public void handleBlockBreak(BlockBreakEvent event) {
        ...
        if (playerData.isInStaffMode() && !player.hasPermission("revampsystem.staff.mode.break.blocks")) {
            event.setCancelled(true);
        }
    }
    ...
    public void handleBlockPlace(BlockPlaceEvent event) {
        ...
        if (playerData.isInStaffMode() && !player.hasPermission("revampsystem.staff.mode.place.blocks")) {
            event.setCancelled(true);
        }
    }
