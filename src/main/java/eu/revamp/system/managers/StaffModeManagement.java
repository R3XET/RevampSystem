...
import eu.revamp.system.data.staffmode.LastInventory;
...
public class StaffModeManagement extends Manager {
    ...
    public void enableStaffMode(Player player) {
        ...
        this.items.forEach(staffModeItem -> player.getInventory().setItem(staffModeItem.getSlot(), staffModeItem.build()));
