package eu.revamp.system.database.redis.other;

import com.google.gson.JsonObject;
import eu.revamp.system.database.redis.other.publisher.JedisPublisher;
import eu.revamp.system.database.redis.other.settings.JedisSettings;
import eu.revamp.system.database.redis.other.suscriber.JedisSubscriber;
import eu.revamp.system.database.redis.payload.GlobalSuscription;
...
public class RedisData {
    ...
    public RedisData(JedisSettings settings) {
        ...
        try {
            ...
            try {
                ...
                this.subscriber = new JedisSubscriber("revampsystem", this.settings, new GlobalSuscription());
    ...
    public void write(JedisAction payload, JsonObject data) {
        ...
        object.addProperty("payload", payload.name());
        object.add("data", data == null ? new JsonObject() : data);
        this.publisher.write("revampsystem", object);
    }
    ...
    public void sendChannelToBungee(String object) {
        ...
        Bukkit.getServer().sendPluginMessage(plugin, "RevampSync", b.toByteArray());
    }
}
