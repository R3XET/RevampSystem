...
public class CommandFramework implements CommandExecutor {
    ...
    @Getter public static CommandFramework instance;
    ...
    public boolean handleCommand(CommandSender sender, org.bukkit.command.Command cmd, String label, String[] args) {
        for (int i = args.length; i >= 0; i--) {
            ...
            if (commandMap.containsKey(cmdLabel)) {
                ...
                if (command.isAdminOnly() && !sender.hasPermission("*")) {
    ...
    public void registerCommands(Object obj, List<String> aliases) {
        for (Method m : obj.getClass().getMethods()) {
            if (m.getAnnotation(Command.class) != null) {
                ...
                boolean parse = false;
                for (String disabled : RevampSystem.INSTANCE.getCoreConfig().getStringList("disabled-commands")) {
                ...
                if (!RevampSystem.INSTANCE.getCoreConfig().getBoolean("coins.enabled")) {
                ...
                if (!RevampSystem.INSTANCE.getCoreConfig().getBoolean("economy.enabled")) {
                    ...
                    if (command.name().equalsIgnoreCase("economy") || command.name().equalsIgnoreCase("balance") || command.name().equalsIgnoreCase("pay")) {
                        parse = true;
                    }
                }
