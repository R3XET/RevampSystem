package eu.revamp.system.punishments.menus;
...
import eu.revamp.system.punishments.menus.alts.AltsMenu;
import eu.revamp.system.punishments.menus.alts.PotentialAltsMenu;
import eu.revamp.system.punishments.menus.punishments.*;
...
public class CheckMenu extends AquaMenu {
    ...
    @AllArgsConstructor
    private static class BansSlot extends Slot {
