...
public enum Language {
    ...
    PREFIX("PREFIX", "&7(&3RevampSystem&7) &8» "),

    FOR_CONSOLE_ONLY("FOR_CONSOLE_USE_ONLY", "{prefix} &cYou cannot perform this command from game."),
    FOR_PLAYER_USE_ONLY("FOR_PLAYER_USE_ONLY", "{prefix} &cYou cannot perform this command from console."),
    MUST_BE_INTEGER("MUST_BE_INTEGER", "{prefix} &cThis must be an integer!"),
    ...
    GRANT_USAGE("GRANT-PROCEDURE.USAGE", "{prefix} &cCorrect usage: /grant (player)"),
    GRANTS_USAGE("GRANTS-PROCEDURE.USAGE", "{prefix} &cCorrect usage: /grants (player)"),
    ...
    GETIP_USAGE("GETIP.USAGE", "{prefix} &cCorrect usage: /getip (player)"),

    SETRANK_USAGE("SETRANK.USAGE", "{prefix} &cCorrect usage: /setrank (player) (rank) (duration) (server) (reason...)"),

    REPORTS_USAGE("REPORTS.USAGE", "{prefix} &cCorrect usage: /reports (player)"),

    REPORT_USAGE("REPORT.USAGE", "{prefix} &cCorrect usage: /report (player) (reason)"),
    ...
    HELPOP_USAGE("HELPOP.USAGE", "{prefix} &cCorrect usage: /helpop (reason)"),
    HELPOP_TO_PLAYER("HELPOP-TO-PLAYER", "{prefix} &aYour helpop has been successfully sent to all staff."),
    HELPOP_FORMAT("HELPOP-FORMAT", "&2[H] &a%player% &3requested staff help for &b%reason%&3."),
    HELPOP_COOLDOWN("HELPOP-COOLDOWN", "{prefix} &3You're on a &bhelpop &3cooldown for another &b%seconds% seconds&3."),

    GAMEMODE_USAGE("GAMEMODE.USAGE", "{prefix} &cCorrect usage: /gamemode (survival|creative|adventure)"),
    ...
    NICK_USAGE("NICK.USAGE", "{prefix} &cCorrect usage: /nick (displayname|none)"),
    NICK_LENGTH("NICK.LENGTH", "{prefix} &cNickname length must be between 5 and 16 chars, including & for colors"),


    //----EXP----//
    EXP_COMMAND_USAGE("EXP.COMMAND-USAGE", "{prefix} &cCorrect usage: /exp set (player) (amount)"),
    EXP_SET("EXP.SET", "{prefix} &bYou have set your exp to &a%exp%&b!"),
    EXP_SET_OTHER("EXP.SET-OTHER", "{prefix} &bYou have set &a%player%&b's exp to &a%exp%&b!"),
    EXP_SET_OTHER_TARGET("EXP.SET-OTHER-TARGET", "{prefix} &bYour exp was set to &a%exp% &bby &a%player%&b!"),
    ...
    MESSAGES_USAGE("MESSAGES.USAGE", "{prefix} &cCorrect usage: /message (player) (msg)"),
    MESSAGES_REPLY_USAGE("MESSAGES.REPLY.USAGE", "{prefix} &cCorrect usage: /reply (msg)"),
    MESSAGES_IGNORE_USAGE(  "MESSAGES.IGNORE.USAGE", "&7&m--------------------------------------------- {0} &e&lIgnore Help {0} &e/ignore add (name) &8- &7add player to ignore list. {0} &e/ignore remove (name) &8- &7remove player from ignore list. {0} &e/ignore list &8- &7see who you are ignoring. {0} &7&m---------------------------------------------"),
    MESSAGES_IGNORE_CANNOT_ADD_YOURSELF("MESSAGES.IGNORE.CANNOT_ADD_YOURSELF", "{prefix} &cYou can't add yourself to ignore list."),
    ...
    SERVER_MANAGER_USAGE("SERVER-MANAGER.USAGE", "&7&m--------------------------------------------- {0} &e&lServer Manager Help {0} {0} &e/servermanager runcmd (server|all) (cmd) &8- &7run console command on all or spectific server. {0} &e/servermanager info (server) &8- &7see info about server. {0} &e/servermanager listservers &8- &7see currently connected servers. {0} &7&m---------------------------------------------"),
    ...
    CAME_ONLINE("SERVER-MANAGER.SERVER-ONLINE", "&7(&4ServerManager&7) &b%server% &3has just came &aonline &band will be joinable in &b5 seconds&3!"),
    WENT_OFFLINE("SERVER-MANAGER.SERVER-OFFLINE", "&7(&4ServerManager&7) &b%server% &3has just went &coffline &3and is no longer joinable&3!"),

    FREEZE_GUI_USAGE("FREEZE.GUI.USAGE", "{prefix} &cCorrect usage: /guifreeze (player)"),
    FREEZE_USAGE("FREEZE.USAGE", "{prefix} &cCorrect usage: /freeze (player)"),
    ...
    PANIC_STAFF_ALERT("PANIC.STAFF", "&7(&4&lPanic&7) &8» &c(%server%) &4&l%name% &bjust used panic ability by typing &c/panic&b."),

    UNPANIC_USAGE("PANIC.UNPANIC.USAGE", "{prefix} &cCorrect usage: /unpanic (player)"),
    ...
    BROADCAST_USAGE("BROADCAST-USAGE", "{prefix} &cCorrect usage: /broadcast (message...)"),
    BROADCAST_FORMAT("BROADCAST-FORMAT", "&7(&bBroadcast&7) &8»  &3%message%"),
    ALERT_USAGE("ALERT-USAGE", "{prefix} &cCorrect usage: /alert (message...)"),
    ...
    TELEPORT_USAGE("TELEPORT.USAGE", "{prefix} &cCorrect usage: /teleport (player)"),
    TELEPORT_HERE_USAGE("TELEPORT.HERE.USAGE", "{prefix} &cCorrect usage: /teleporthere (player)"),
    ...
    TELELPORT_TO_COORDS("TELEPORT.TO-COORDS.MESSAGE", "{prefix} &bYou've been teleported to &3x:%x%&7, &3y:%y%&7, &3z:%z%&b."),
    TELELPORT_TO_COORDS_USAGE("TELEPORT.TO-COORDS.USAGE", "{prefix} &cCorrect usage: /teleportposition (x) (y) (z)"),
    ...
    LORE_ADD_USAGE("LORE.ADD.USAGE", "{prefix} &cCorrect usage: /addlore (lore)"),
    LORE_REMOVE_USAGE("LORE.REMOVE.USAGE", "{prefix} &cCorrect usage: /removelore (number)"),
    ...
    ENCHANT_COMMAND_USAGE("ENCHANT.COMMAND_USAGE", "{prefix} &cCorrect usage: /enchant (enchantment) (level)"),
    ENCHANT_ENCHANTED("ENCHANT.ENCHANTED", "{prefix} &aYou have successfully enchanted %item%!"),
    ENCHANT_CAN_NOT_ENCHANT_ITEM("ENCHANT.CAN_NOT_ENCHANT_ITEM", "{prefix} &cYou can't enchant that!"),
    ENCHANT_LEVEL_MUST_BE_POSITIVE("ENCHANT.LEVEL_MUST_BE_POSITIVE", "{prefix} &cLevel must be positive!"),
    ENCHANT_NO_ENCHANT("ENCHANT.NO_ENCHANT", "{prefix} &cThat item doesn't contain %enchant%!"),
    ENCHANT_REMOVED("ENCHANT.REMOVED", "{prefix} &aYou have successfully removed %enchant%!"),
    ENCHANT_LIMIT("ENCHANT.LIMIT", "{prefix} &cLevel must be lower than %level%!"),
    ENCHANT_UNKNOWN("ENCHANT.UNKNOWN", "{prefix} &cUnknown enchant: %enchant%!"),
    ...
    CHAT_USAGE("CHAT.USAGE", "&7&m--------------------------------------------- {0} &e&lChat Help {0} {0} &e/chat mute &8- &7mute chat. {0} &e/chat unmute &8- &7un-mute chat. {0} &e/chat clear &8- &7clear the chat {0} &e/chat slow (seconds) &8- &7slow down the chat. {0} &7&m---------------------------------------------"),
    ...
    CHAT_CLEAR("CHAT.CLEARED", "{prefix} &bGlobal chat has been cleared by &3%player%&b."),

    SUDO_USAGE("SUDO.USAGE", "{prefix} &cCorrect usage: /sudo (player) (chat|command)"),
    ...
    STAFF_HISTORY_USAGE("STAFF-HISTORY.USAGE", "{prefix} &cCorrect usage: /staffhistory (player)"),


    STAFF_ROLLBACK_USAGE("STAFF-ROLLBACK.USAGE", "{prefix} &cCorrect usage: /staffrollback (staff) (time) (type) {0} {prefix} &cFor the type you can use 'Bans, Mutes, Blacklists or Warns'"),
    ...
    MASSAY_USAGE("MASSAY.USAGE", "{prefix} &cCorrect usage: /massay (message)"),
    MASSAY_SUCCESS("MASSAY.SUCCESS", "{prefix} &bYou have successfully made everyone to type &3%message%"),

    SPEED_USAGE("SPEED.USAGE", "{prefix} &cCorrect usage: /speed (fly|walk) (amount)"),
    ...
    REPAIR_USAGE("REPAIR.USAGE", "{prefix} &cCorrect usage: /repair (hand|all|armor)"),
    ...
    //WARP_USAGE("WARP-USAGE", "{prefix} &cCorrect usage: /warp (warp)"),
    WARP_TELEPORTED("WARP-TELEPORTED", "{prefix} &eWarped to %warp%"),
    WARP_DOES_NOT_EXIST("WARP-DOES-NOT-EXIST", "{prefix} &cWarp %warp% doesn't exist!"),
    WARP_SET_USAGE("WARP-SET-USAGE", "{prefix} &cCorrect usage: /setwarp (warp)"),
    WARP_SET("WARP-SET", "{prefix} &aYou have set the %warp% warp location."),
    WARP_LIST("WARP-LIST", "{prefix} &aWarps: %warps%"),


    //----DELWARP----//
    DELWARP_USAGE("DELWARP.COMMAND_USAGE", "{prefix} &cCorrect usage: /delwarp (name)"),
    DELWARP_DELETED("DELWARP.DELETED", "{prefix} &aWarp %warp% has been successfully deleted!"),
    DELWARP_NOT_FOUND("DELWARP.NOT_FOUND", "{prefix} &cWarp not found."),



    JOIN_SPAWN_SET("JOIN-SPAWN-SET", "{prefix} &aYou have updated join location for Revamp System."),
    ...
    SPAWN_SET("SPAWN-SPAWN-SET", "{prefix} &aYou have updated spawn location for Revamp System."),
    ...
    BLACKLISTED_PERMISSIONS_USAGE("BLACKLISTED_PERMISSIONS.USAGE", "{prefix} &cCorrect usage: /blacklistedpermissions [add|remove] (permission)"),
    BLACKLISTED_PERMISSIONS_ALREADY_ADDED("BLACKLISTED_PERMISSIONS.ALREADY-ADDED", "{prefix} &bThat permission is already blacklisted."),
    BLACKLISTED_PERMISSIONS_ADDED("BLACKLISTED_PERMISSIONS.ADDED", "{prefix} &bYou have added &3%permission% &bto blacklisted permissions."),
    BLACKLISTED_PERMISSIONS_DONT_EXISTS("BLACKLISTED_PERMISSIONS.DONT-EXISTS", "{prefix} &bThat permission is not currently blacklisted."),
    BLACKLISTED_PERMISSIONS_REMOVED("BLACKLISTED_PERMISSIONS.REMOVED", "{prefix} &bYou have removed &3%permission% &bfrom blacklisted permissions."),

    INFO_USAGE("INFO.USAGE", "{prefix} &cCorrect usage: /info (player)"),


    SETPERMISSION_USAGE("SETPERMISSION.USAGE", "{prefix} &cCorrect usage: /setpermission (user) (permission) (true|false)"),
    ...
    COINS_USAGE("COINS.USAGE","{prefix} {0} &e&lCoins HELP {0} &e/coins set (player) (amount) {0} &e/coins add (player) (amount) {0} &e/coins remove (player) (amount)"),

    COINS_BUY_USAGE("COINS.BUY.USAGE", "{prefix} {0} &eIf you want to purchase ranks use {0} &b/coins buy &eto purchase! {0}"),
    ...
    COINS_NO_RANKS_TO_PURCHASE("COINS.NO-RANK-TO-PURCHASE", "{prefix} &eThere are no ranks that can be currently purchased!"),
    ...
    ECONOMY_USAGE("ECONOMY.USAGE","{prefix} {0} &e&lEconomy HELP {0} &e/economy set (player) (amount) {0} &e/economy add (player) (amount) {0} &e/economy remove (player) (amount)"),
    ECONOMY_SET("ECONOMY.SET", "{prefix} &eYou have successfully set &b%player%'s &ebalance to &b%amount%&e."),
    ECONOMY_ADD("ECONOMY.ADD", "{prefix} &eYou have successfully add &b%amount% &eto &b%player%."),
    ECONOMY_REMOVE("ECONOMY.REMOVE", "{prefix} &eYou have successfully removed &b%amount% &eto &b%player%."),

    BALANCE_MESSAGE("BALANCE.MESSAGE", "{prefix} &eYou currently have &e$&b%money% &7."),
    BALANCE_MESSAGE_OTHERS("BALANCE.MESSAGE-OTHERS", "{prefix} &e%player% currently has &e$&b%money% &7."),


    PAY_USAGE("PAY.USAGE","{prefix} &cCorrect usage: /pay (player) (amount)"),
    PAY_PAYED("PAY.PAYED","{prefix} &eYou have successfully payed $&b%money% &eto &b%player%."),
    PAY_RECEIVED("PAY.RECEIVED","{prefix} &eYou have received $&b%money% &efrom &b%player%."),
    ...
    NOTE_USAGE("NOTE.USAGE", "&7&m----------------------------------- {0} &c&lNotes Help {0} {0} &c/notes (player) &7- &ccheck notes of player {0} &c/notes add (player) (note) &7- &cadd notes to player {0} &c/notes remove (player) (id) &7- &cremove notes from player {0} &7&m-----------------------------------"),
    ...
    STAFF_AUTH_DISABLED("STAFF-AUTH.DISABLED", "{prefix} &cAuthentication is currently disabled."),
    ...
    private ConfigFile configFile = RevampSystem.INSTANCE.getLanguage();
